...
<!rule NewDevice_Init_0 [color=#FFEFD5]:
    ...
    [
        NewDevice0($D,~DeviceUUID,PKType,OutputOOB,InputOOB,StaticOOB,NDevSeOp,'NewDevice')
    ]
...
rule NewDevice_Init_InBandPK_NoStaticOOB [color=#FFEFD5]:
    ...
    in
    [
        NewDevice0(NDev,DeviceUUID,PKType,OutputOOB,InputOOB,StaticOOB,NDevSeOp,'NewDevice')
    ]
    --[
        Eq(PKType,'InBand'),
        Eq(StaticOOB,'0'),
    ...
    [
        !NewDevice(NDev,DeviceUUID,PKType,OutputOOB,InputOOB,StaticOOB,NDevSeOp,skD,DHpkD,OOBPKURI,AuthValue,AuthValueURI,'NewDevice')
    ]
...
rule NDev_Beaconing [color=#FFF68F]:
    ...
    [
        ...
        NDevBeaconing(NDev,DeviceUUID,PKType,OutputOOB,InputOOB,StaticOOB,NDevSeOp,skD,DHpkD,OOBPKURI,AuthValue,AuthValueURI)
    ]
...
rule NDev_LinkAck [color=#FFF68F]:
    ...
    [
        Out(<LinkID,'Ack'>),
        NDevLinkOpened(NDev,DeviceUUID,PKType,OutputOOB,InputOOB,StaticOOB,NDevSeOp,skD,DHpkD,OOBPKURI,AuthValue,AuthValueURI,LinkID)
    ]
...
rule NDev_Capabilities [color=#FFF68F]:
    ...
    [
        ...
        NDevSentCapabilities(NDev,DeviceUUID,PKType,OutputOOB,InputOOB,StaticOOB,NDevSeOp,skD,DHpkD,OOBPKURI,AuthValue,AuthValueURI,LinkID)
    ]
...
rule NDev_ReceiveStart [color=#FFF68F]:
    [
        ...
        NDevSentCapabilities(NDev,DeviceUUID,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,NDevSeOp,skD,DHpkD,OOBPKURI,AuthValue,AuthValueURI,LinkID)
    ]
    --[
...
restriction SecurePolicyCheck:
    "All ppk pam dso #i. SecurePolicyCheck(ppk, pam, dso) @#i ==>
        ( 
            ( dso = '1' & 
                ( pam = 'OutputOOB' 
                | pam = 'InputOOB' 
...
rule Prov_Confirmation_1 [color=#BBFFFF]:
    ...
    [
        Out(<LinkID,Cp_1>),
        ProvSentConfirm_1(Prov,NetKey,ReadOOBPK,ReadStaticOOB,SecureOption,NDev,DeviceUUID,LinkID,OOBPKURI,AuthValueURI,AuthValue_In,AuthValue_1,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,PKType_P,AuthMethod_P,skP,DHpkP,DHpkD,ECDHSecret,Np_1,ConfirmSALT,ECDH1,ECDH2,CK,Cp_1)
    ]

rule NDev_Confirmation_1 [color=#FFF68F]:
    let
        Nd_1 = ~Nd
        AuthValue_1 = <fst(AuthValue_In),'2'>
        ConfirmSALT = s1(<DHpkP,DHpkD>)
    ...
    [
        Out(<LinkID,Cd_1>),
        NDevSentConfirm_1(NDev,DeviceUUID,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,skD,DHpkD,OOBPKURI,AuthValue_In,AuthValue_1,AuthValueURI,LinkID,PKType_P,AuthMethod_P,DHpkP,ECDHSecret,Cp_1,Nd_1,ConfirmSALT,ECDH1,ECDH2,CK,Cd_1)
    ]

rule Prov_SendNonce_1 [color=#BBFFFF]:
    [
        In(<LinkID,Cd_1>),
        ProvSentConfirm_1(Prov,NetKey,ReadOOBPK,ReadStaticOOB,SecureOption,NDev,DeviceUUID,LinkID,OOBPKURI,AuthValueURI,AuthValue_In,AuthValue_1,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,PKType_P,AuthMethod_P,skP,DHpkP,DHpkD,ECDHSecret,Np_1,ConfirmSALT,ECDH1,ECDH2,CK,Cp_1)
    ]
    ...
    [
        Out(<LinkID,Np_1>),
        ProvSentNonce_1(Prov,NetKey,ReadOOBPK,ReadStaticOOB,SecureOption,NDev,DeviceUUID,LinkID,OOBPKURI,AuthValueURI,AuthValue_In,AuthValue_1,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,PKType_P,AuthMethod_P,skP,DHpkP,DHpkD,ECDHSecret,Np_1,ConfirmSALT,ECDH1,ECDH2,CK,Cp_1,Cd_1)
    ]

rule NDev_SendNonce_1 [color=#FFF68F]:
    [
        In(<LinkID,Np_1>),
        NDevSentConfirm_1(NDev,DeviceUUID,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,skD,DHpkD,OOBPKURI,AuthValue_In,AuthValue_1,AuthValueURI,LinkID,PKType_P,AuthMethod_P,DHpkP,ECDHSecret,Cp_1,Nd_1,ConfirmSALT,ECDH1,ECDH2,CK,Cd_1)
    ]
    --[
        Check(Cp_1, CK+AuthValue_1, Np_1)
    ]->
    [
        Out(<LinkID,Nd_1>),
        NDevSentNonce_1(NDev,DeviceUUID,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,skD,DHpkD,OOBPKURI,AuthValue_In,AuthValue_1,AuthValueURI,LinkID,PKType_P,AuthMethod_P,DHpkP,ECDHSecret,Cp_1,Nd_1,ConfirmSALT,ECDH1,ECDH2,CK,Cd_1,Np_1)
    ]

rule Prov_Confirmation_2 [color=#BBFFFF]:
// Check the Nonce, generate Cp_2 and out it.
    let
        Np_2 = ~Np
        AuthValue_2 = <snd(AuthValue_In),'2'>
        Cp_2 = cmac(CK+AuthValue_2, Np_2)
    in
    [
        In(<LinkID,Nd_1>),
        Fr(~Np),
    ...
    --[
        Running_Prov(Prov,NDev,<ECDHSecret,Np_1,Np_2>),
        Check(Cd_1, CK+AuthValue_1, Nd_1)
    ]->
    [
        Out(<LinkID,Cp_2>),
        ProvSentConfirm_2(Prov,NetKey,ReadOOBPK,ReadStaticOOB,SecureOption,NDev,DeviceUUID,LinkID,OOBPKURI,AuthValueURI,AuthValue_In,AuthValue_1,AuthValue_2,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,PKType_P,AuthMethod_P,skP,DHpkP,DHpkD,ECDHSecret,Np_1,ConfirmSALT,ECDH1,ECDH2,CK,Cp_1,Cd_1,Nd_1,Np_2,Cp_2)
    ]

rule NDev_Confirmation_2 [color=#FFF68F]:
// Receive Cp_2, generate Cd_2 and out it.
    let
        Nd_2 = ~Nd
        AuthValue_2 = <snd(AuthValue_In),'2'>
        Cd_2 = cmac(CK+AuthValue_2, Nd_2)
    in
    [
        In(<LinkID,Cp_2>),
        Fr(~Nd),
    ...
    --[
        Running_NDev(NDev,<ECDHSecret,Nd_1,Nd_2>),
        Neq(Cp_2, Cd_2)
    ]->
    [
        Out(<LinkID,Cd_2>),
        NDevSentConfirm_2(NDev,DeviceUUID,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,skD,DHpkD,OOBPKURI,AuthValue_In,AuthValue_1,AuthValue_2,AuthValueURI,LinkID,PKType_P,AuthMethod_P,DHpkP,ECDHSecret,Cp_1,Nd_1,ConfirmSALT,ECDH1,ECDH2,CK,Cd_1,Np_1,Cp_2,Nd_2,Cd_2)
    ]

rule Prov_SendNonce_2 [color=#BBFFFF]:
// Receive Cd_2, Out Np_2
    [
        In(<LinkID, Cd_2>),
        ProvSentConfirm_2(Prov,NetKey,ReadOOBPK,ReadStaticOOB,SecureOption,NDev,DeviceUUID,LinkID,OOBPKURI,AuthValueURI,AuthValue_In,AuthValue_1,AuthValue_2,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,PKType_P,AuthMethod_P,skP,DHpkP,DHpkD,ECDHSecret,Np_1,ConfirmSALT,ECDH1,ECDH2,CK,Cp_1,Cd_1,Nd_1,Np_2,Cp_2)
    ]
    ...
    [
        Out(<LinkID,Np_2>),
        ProvSentNonce_2(Prov,NetKey,ReadOOBPK,ReadStaticOOB,SecureOption,NDev,DeviceUUID,LinkID,OOBPKURI,AuthValueURI,AuthValue_In,AuthValue_1,AuthValue_2,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,PKType_P,AuthMethod_P,skP,DHpkP,DHpkD,ECDHSecret,Np_1,ConfirmSALT,ECDH1,ECDH2,CK,Cp_1,Cd_1,Nd_1,Np_2,Cp_2,Cd_2)
    ]

rule NDev_SendNonce_2 [color=#FFF68F]:
// Receive Np_2, Check it, out Nd_2
    let
        ProvisioningSALT = s1(<ConfirmSALT,Np_2,Nd_2>)
    ...
    --[
        Check(Cp_2, CK+AuthValue_2, Np_2)
    ]->
    [
        Out(<LinkID, Nd_2>),
        NDevSentNonce_2(NDev,DeviceUUID,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,skD,DHpkD,OOBPKURI,AuthValue_In,AuthValue_1,AuthValue_2,AuthValueURI,LinkID,PKType_P,AuthMethod_P,DHpkP,ECDHSecret,Cp_1,Nd_1,ConfirmSALT,ECDH1,ECDH2,CK,Cd_1,Np_1,Cp_2,Nd_2,Cd_2,Np_2,ProvisioningSALT,SessionKey)
    ]
...
rule Prov_Check [color=#BBFFFF]:
    ...
    --[
        Check(Cd_2, CK+AuthValue_2, Nd_2)
    ]->
    [
        ProvChecked(Prov,NetKey,ReadOOBPK,ReadStaticOOB,SecureOption,NDev,DeviceUUID,LinkID,OOBPKURI,AuthValueURI,AuthValue_In,AuthValue_1,AuthValue_2,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,PKType_P,AuthMethod_P,skP,DHpkP,DHpkD,ECDHSecret,Np_1,ConfirmSALT,ECDH1,ECDH2,CK,Cp_1,Cd_1,Nd_1,Np_2,Cp_2,Cd_2,Nd_2,ProvisioningSALT,SessionKey)
    ]
...
rule Prov_Distribute [color=#BBFFFF]:
    ...
    [
        Out(<LinkID,ProvData>),
        ProvDistributed(Prov,NetKey,ReadOOBPK,ReadStaticOOB,SecureOption,NDev,DeviceUUID,LinkID,OOBPKURI,AuthValueURI,AuthValue_In,AuthValue_1,AuthValue_2,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,PKType_P,AuthMethod_P,skP,DHpkP,DHpkD,ECDHSecret,Np_1,ConfirmSALT,ECDH1,ECDH2,CK,Cp_1,Cd_1,Nd_1,Np_2,Cp_2,Cd_2,Nd_2,ProvisioningSALT,SessionKey,ProvData,DevKey)
    ]
...
rule NDev_Complete [color=#FFF68F]:
    ...
    --[
        FinishedD(),
        Commit_NDev(NDev,<ECDHSecret,Np_1,Np_2>),
        Role('NDev')
    ]->
    [
        Out(<LinkID,'Complete'>),
        NDevComplete(NDev,DeviceUUID,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,skD,DHpkD,OOBPKURI,AuthValue_In,AuthValue_1,AuthValue_2,AuthValueURI,LinkID,PKType_P,AuthMethod_P,DHpkP,ECDHSecret,Cp_1,Nd_1,ConfirmSALT,ECDH1,ECDH2,CK,Cd_1,Np_1,Cp_2,Nd_2,Cd_2,Np_2,ProvisioningSALT,SessionKey,DevKey,NetKey)
    ]
...
rule Prov_Complete [color=#BBFFFF]:
    ...
    --[
        FinishedP(),
        Commit_Prov(Prov,NDev,<ECDHSecret,Nd_1,Nd_2>)
    ]->
    [
        ProvComplete(Prov,NetKey,ReadOOBPK,ReadStaticOOB,SecureOption,NDev,DeviceUUID,LinkID,OOBPKURI,AuthValueURI,AuthValue_In,AuthValue_1,AuthValue_2,PKType_D,OutputOOB_D,InputOOB_D,StaticOOB_D,PKType_P,AuthMethod_P,skP,DHpkP,DHpkD,ECDHSecret,Np_1,ConfirmSALT,ECDH1,ECDH2,CK,Cp_1,Cd_1,Nd_1,Np_2,Cp_2,Cd_2,Nd_2,ProvisioningSALT,SessionKey,ProvData,DevKey)
    ]
